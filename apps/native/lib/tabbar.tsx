...
export function TabBar({ state, navigation }: BottomTabBarProps) {
            ...
            >
               ...
               {label ? (
                  <Text
                     ...
                     className={`text-[10px] tracking-[0.2px] ${isActive ? "text-foreground font-bold" : "text-muted-foreground"
                        }`}
                  >
                     {label}
                  </Text>
   ...
   return (
      ...
      >
         ...
         >
            <View className="flex-row items-center bg-surface rounded-2xl px-3.5 py-0.3 gap-2.5">
