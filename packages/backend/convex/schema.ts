...
export default defineSchema({
  ...
  habits: defineTable({
    ...
    breakGoal: v.optional(v.union(v.literal("quit"), v.literal("limit"))),
    breakMetric: v.optional(v.union(v.literal("times"), v.literal("minutes"))),
    targetValue: v.optional(v.number()),
    targetUnit: v.optional(v.string()),
    targetType: v.optional(v.union(v.literal("binary"), v.literal("quantity"), v.literal("duration"))),
    frequencyType: v.optional(v.union(v.literal("daily"), v.literal("weekly"))),
